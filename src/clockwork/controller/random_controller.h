...
// Multi Machine, Multi GPU Random Controller, randomly assignes the inference to a gpu (on a random worker)
class RandomControllerImpl : public Controller {
public:
	...
	RandomControllerImpl(int client_port, std::vector<std::pair<std::string, std::string>> worker_host_port_pairs);
